...
public class ItemHandler : MonoBehaviour
{
    ...
    public void equipItem()
    {
        ...
        primaryRangedWeapon = Instantiate(primaryRangedWeapon, itemPosition, transform.rotation);
        primaryRangedWeapon.transform.Rotate(new Vector3(90, -180, 0), Space.Self);
